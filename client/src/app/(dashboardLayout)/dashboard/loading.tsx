    ...
    <div className="flex min-h-screen flex-col animate-in fade-in duration-700">
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 xl:grid-cols-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex h-[142px] flex-col justify-between rounded-xl border border-border/40 bg-card/40 p-5">
              <div className="flex items-center justify-between">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px] items-start">
          <Skeleton className="h-[250px] w-full rounded-2xl border border-border/40" />
          <Skeleton className="h-[250px] w-full rounded-2xl border border-border/40" />
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <Skeleton className="h-9 w-64 rounded-lg border border-border/40" />

          <div className="rounded-2xl border border-border/40 bg-card/20 overflow-hidden">
             <div className="h-10 border-b border-border/40 bg-muted/20 px-6 flex items-center gap-4">
                <Skeleton className="h-3 w-full opacity-30" />
             </div>
             {[1,2,3,4,5].map(row => (
                <div key={row} className="px-6 py-4 border-b border-border/10 last:border-0 flex items-center gap-6">
