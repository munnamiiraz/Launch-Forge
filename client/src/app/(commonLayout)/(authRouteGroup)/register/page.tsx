...
export const metadata: Metadata = {
  title: "Join the Forge — LaunchForge",
  description: "Create your professional account and start building viral waitlists today.",
};
...
export default function RegisterPage() {
  return (
    <main className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-zinc-950 px-4">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -left-20 top-0 h-[500px] w-[500px] rounded-full bg-indigo-600/10 blur-[120px] mix-blend-screen animate-pulse"
      />

      {/* Secondary depth glow */}
      <div
        aria-hidden
        className="pointer-events-none absolute -right-20 bottom-0 h-[400px] w-[400px] rounded-full bg-violet-600/5 blur-[100px] mix-blend-screen"
      />
