    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative max-w-xs">
        ...
        <Input
          ...
          className="h-9 border-border bg-card/60 dark:bg-card/40 pl-8 text-xs text-foreground placeholder:text-muted-foreground/60 focus-visible:border-indigo-500/50 focus-visible:ring-0"
        />
      </div>
      ...
      <Card className="overflow-hidden border-border/80 bg-card/40">
        <div className="overflow-x-auto custom-scrollbar">
          <div className="min-w-[500px]">
            {/* Header */}
            <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_80px] border-b border-border/60 bg-card/60 px-4 py-2.5">
              {["Waitlist", "Category", "Subscribers", "Referrals", "Status", ""].map((h) => (
              ...
              <div className="divide-y divide-border/40">
                {filtered.map((wl, i) => (
                  <motion.div
                    ...
                    className="group grid grid-cols-[2fr_1fr_1fr_1fr_1fr_80px] items-center px-4 py-3.5 hover:bg-card/40 transition-colors"
                  >
                    {/* Name */}
                    <div className="flex items-center gap-3 min-w-0">
                      <Avatar className="h-8 w-8 shrink-0 rounded-lg">
                        {wl.logoUrl ? (
                          ...
                          <AvatarFallback
                            className={cn(
                              "rounded-lg bg-linear-to-br text-xs font-bold text-white",
                    ...
                    <div>
                      <Badge 
                        variant="outline" 
                        className="border-indigo-500/10 bg-indigo-500/5 px-2 py-0 text-[10px] text-indigo-400 group-hover:border-indigo-500/20 transition-all"
                      >
                        {wl.category || "Other"}
                      </Badge>
                    </div>
