...
const STATUS_CONFIG = {
  ...
  void:   { label: "Void",   classes: "border-zinc-700/60 bg-muted/40 text-muted-foreground/80",          icon: <AlertCircle  size={10} /> },
};
...
export function InvoiceHistory({ invoices }: InvoiceHistoryProps) {
  ...
  return (
    <Card className="relative overflow-hidden border-border/80 bg-card/40">
      ...
      {/* Table header */}
      <div className="hidden grid-cols-[1fr_auto_auto_auto] gap-4 border-b border-border/60 bg-card/60 px-5 py-2.5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/60 sm:grid">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-zinc-800 bg-card/60">
