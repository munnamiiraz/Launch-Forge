...
export function InviteUserModal({ open, onClose }: InviteUserModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) { onClose(); reset(); } }}>
      <DialogContent className="border-border/80 bg-background/98 p-0 shadow-2xl shadow-black/60 backdrop-blur-xl sm:max-w-md">
          ...
          {success ? (
            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground/80">{email}</p>
              </div>
            </motion.div>
          ) : (
            <motion.form
            ...
            >
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="invite-email" className="flex items-center gap-1.5 text-xs font-medium text-muted-foreground">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        role === r
                          ...
                          : "border-border/80 bg-card/30 text-muted-foreground/80 hover:border-zinc-700/60",
                      )}
                    >
