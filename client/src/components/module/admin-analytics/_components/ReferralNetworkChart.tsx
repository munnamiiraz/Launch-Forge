    ...
    <Card className="relative overflow-hidden border-zinc-800/80 bg-zinc-900/40">
      ...
      <CardHeader className="border-b border-zinc-800/60 px-5 py-4">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm font-semibold text-zinc-200">Platform referral network</p>
            <p className="text-[11px] text-zinc-600">
              Monthly referrals from <code className="text-zinc-500">Subscriber.referredById</code> across all waitlists
            </p>
          </div>
      ...
      <CardContent className="p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {[
            ...
            <div key={s.label} className="flex items-start gap-2 rounded-lg border border-zinc-800/60 bg-zinc-900/40 px-3 py-2">
