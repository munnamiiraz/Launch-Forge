    ...
    <TooltipProvider delayDuration={200}>
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* Tier tabs */}
          <div className="flex items-center gap-0.5 rounded-lg border border-zinc-800/80 bg-zinc-900/40 p-1">
            {TIER_TABS.map((tab) => {
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  onClick={onRefetch}
                  disabled={isFetching}
                  className="h-8 w-8 rounded-lg border border-zinc-800/80 bg-zinc-900/40 text-zinc-600 hover:border-zinc-700 hover:bg-zinc-800/60 hover:text-zinc-300 disabled:opacity-40"
                >
                  <RefreshCw
                    size={13}
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3 text-[10px] text-zinc-600">
            <span>
              <span className="font-semibold text-zinc-400">{totalCount}</span>{" "}
