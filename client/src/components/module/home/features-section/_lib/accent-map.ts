...
> = {
  indigo: {
    ...
    metricValue: "text-indigo-300",
    ringPing:    "bg-indigo-400",
  },
  violet: {
  ...
  cyan: {
    ...
    bullet:      "bg-cyan-500",
    metricValue: "text-cyan-300",
    ringPing:    "bg-cyan-400",
  },
  emerald: {
    ...
    metricValue: "text-emerald-300",
    ringPing:    "bg-emerald-400",
  },
  amber: {
    icon:        "border-amber-500/30 bg-amber-500/12 text-amber-400",
    border:      "hover:border-amber-500/35",
    topLine:     "via-amber-500/50",
    glow:        "bg-amber-500/10",
    tag:         "border-amber-500/25 bg-amber-500/8 text-amber-400",
    bullet:      "bg-amber-500",
    metricValue: "text-amber-300",
    ringPing:    "bg-amber-400",
  },
  rose: {
    icon:        "border-rose-500/30 bg-rose-500/12 text-rose-400",
    border:      "hover:border-rose-500/35",
    topLine:     "via-rose-500/50",
    glow:        "bg-rose-500/10",
    tag:         "border-rose-500/25 bg-rose-500/8 text-rose-400",
    bullet:      "bg-rose-500",
    metricValue: "text-rose-300",
    ringPing:    "bg-rose-400",
  },
};
