...
export function ProductCard({ product, index, onJoin, onDetail }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className={cn(
        "group relative flex flex-col overflow-hidden rounded-2xl border bg-[#0d0d0d] backdrop-blur-sm",
        ...
        <div className="relative flex flex-1 flex-col gap-4 p-5">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <Badge className={cn(
              ...
              product.isOpen
                ...
                : "border-zinc-700/60 bg-zinc-800/30 text-zinc-600",
            )}>
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            {product.tags.slice(0, 2).map((tag) => (
              <Badge key={tag} className="border-zinc-800 bg-zinc-900/60 px-2 py-0.5 text-[10px] text-zinc-600">
                {tag}
              </Badge>
            ))}
          </div>
        ...
        <div className="border-t border-zinc-800/50 bg-zinc-900/20 px-5 py-3.5">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3 text-[10px] text-zinc-600">
              ...
              <span className="flex items-center gap-1">
                ...
                <span className="font-semibold text-zinc-400">{product.viralScore}×</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="h-7 gap-1 px-2.5 text-xs text-zinc-500 hover:bg-zinc-800/60 hover:text-zinc-300"
              >
                Details
              </Button>
              ...
              {product.isOpen ? (
                ...
                <span className="h-7 rounded-lg border border-zinc-800 px-3 flex items-center text-xs text-zinc-700">
                  Closed
                </span>
              )}
            </div>
